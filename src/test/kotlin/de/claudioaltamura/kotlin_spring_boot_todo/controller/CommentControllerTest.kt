...
class CommentControllerTest {
    ...
    fun `should return comments by todo id`() {
        every { commentService.getCommentsByTodo(any()) }.returns(
            listOf(
                Comment(1L, "a todo", 1L),
                Comment(2L, "a second todo", 1L)
            )
        )
